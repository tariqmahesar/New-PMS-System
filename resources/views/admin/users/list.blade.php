                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>
                      ...
                      @else
                        <span id="status" style="background-color: #dc3545;">In Active</span>
                      @endif
                    </td>
                      
                      
                    <td>
                    <a href="{{route('user.edit',['id' => $user->id])}}"><i style="color: #c49f47;" class="fas fa-pen-square"></i></a> |
                    <a href="{{route('user.delete' , ['id' => $user->id])}}"><i style="color: #bd0a0a;" class="fa fa-trash" aria-hidden="true"></i></a>
